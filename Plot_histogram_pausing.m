...
histogram(Paused_end,'Normalization','probability');
histogram(mRNA_end,'Normalization','probability');

line([mean(mRNA_end),mean(mRNA_end)], ylim, 'LineWidth', 2, 'Color', 'k');
legend('PIC','Pol2 Initiated','Pol2 Engaged','Pol2 FREE','Paused','mRNA');
...
exportgraphics(FINAL_IMAGE,[FILE_PATH,'/','EXPERIMENT_',num2str(jj),'_H','.png'])