...
FILE_PATH = './RESULTS/DASMEH';

% Intialization of components
N_cell = 10; % number of cells to simulate
...
for jj = 1:NUM_EXPERIMENTS
    ...
    run(['EXPERIMENTS/DASMEH/',FILENAME]);
    ...
    for i=1:N_cell
        ...
        [x,t] = DASMEH_MODEL(x0,timelimit,p);       
...
figure(1)
clf
Plot_time_series_DASMEH

figure(2)
clf
Plot_histogram_DASMEH
